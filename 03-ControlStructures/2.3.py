...
fuel_consumption_total = (fuel_consumption / 100) * distance
print(f'Total fuel consumption over a distance of {distance} km in driving mode {driving_mode} is {fuel_consumption_total} liters')
